...
- v1.10.48 发布程序 SHA256：`DAEF038B2392D8E35955445733732C26DAD29F2B25CC3EE23E19C0A2D68A0115`
- v1.10.48 Windows ZIP SHA256：`5F62A2359C0DA711C6AEBF1B3D2FB8AD3E36EDB2C809F6695B7029A5CDE62A49`
- 发布目录根部 `overlay.exe` 已同步为 `v1.10.48`，SHA256 同上。
- 最近归档：`旧版本归档\2026-07-17_1340_v1.10.47_ACE辅助进程误记录修复前`
...
`v1.10.48` 继承现有 UI 与显示逻辑，并保留 v1.10.18 的 G815LR 插座校准：
