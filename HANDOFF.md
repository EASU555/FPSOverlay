...
- v1.10.46 发布程序 SHA256：`F7A6AC2AD9659E313C7CBDE888F1EE1A4E8D06C905FD13832CF9C04D1EB3F1B3`
- 发布目录根部 `overlay.exe` 仍为 `v1.10.44`，SHA256：`B776094B335C04A7F7522CD7B08F2A88064275943E6F684325714687FEDFBF76`。用户运行中的 PID 28436 占用了 EXE 和 LHWM DLL，本轮未强制结束或覆盖。
- 最近归档：`旧版本归档\2026-07-16_2215_v1.10.45_耗电量单位修改前`
...
`v1.10.46` 继承现有 UI 与显示逻辑，并保留 v1.10.18 的 G815LR 插座校准：
