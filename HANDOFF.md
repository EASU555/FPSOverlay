...
- v1.10.44 发布程序 SHA256：`B776094B335C04A7F7522CD7B08F2A88064275943E6F684325714687FEDFBF76`
- 当前根目录 `overlay.exe` SHA256：`B776094B335C04A7F7522CD7B08F2A88064275943E6F684325714687FEDFBF76`。
- 最近归档：`旧版本归档\2026-07-16_1950_v1.10.43_报告遮挡修复前`
...
`v1.10.42` 继承现有 UI 与显示逻辑，并保留 v1.10.18 的 G815LR 插座校准：
...
- 八个页面统一中性石墨表面、编号页头、状态表达和卡片层级，蓝色用于主操作，绿/橙用于成功与注意状态。
