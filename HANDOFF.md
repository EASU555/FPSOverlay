...
- v1.10.47 发布程序 SHA256：`7F0A54653DEEE333949154AA6E5A99A55BB8520320FA9F5ADAFD69D7D5C6F8A9`
- v1.10.47 Windows ZIP SHA256：`FC5DB4C883DF96371D900A8B88843F49EF5D20333E4D8851FB7996D2153E970F`
- 发布目录根部 `overlay.exe` 已同步为 `v1.10.47`，SHA256 同上。
- 最近归档：`旧版本归档\2026-07-16_2255_v1.10.46_对抗性修复前`
...
`v1.10.47` 继承现有 UI 与显示逻辑，并保留 v1.10.18 的 G815LR 插座校准：
